...
/**
 * R 线程安全Demo 通过设置JVM的参数，打印出jit编译的内容 -server -XX:+UnlockDiagnosticVMOptions -XX:+PrintAssembly
 * -XX:+LogCompilation -XX:LogFile=jit.log 关闭jit优化：-Djava.compiler=NONE
 *
 * @author Cdu
